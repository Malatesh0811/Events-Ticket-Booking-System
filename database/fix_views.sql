...
-- Recreate View 2: Show Details (without date filter for now)
...
-- Recreate View 3: User Booking History
...
CREATE VIEW venue_performance AS
SELECT 
    v.venue_id,
    v.venue_name,
    v.city,
